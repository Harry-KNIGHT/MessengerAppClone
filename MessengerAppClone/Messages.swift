...
struct Message: Identifiable {
    ...
    static var all = [
        Message(author: Author.all[0], lastMessageContent: "Salut Mon ami!", creationDate: Date().addingTimeInterval(-6500)),
        ...
        Message(author: Author.all[3], lastMessageContent: "Qu'est-ce qu'il fait beau ! On va au parc du Luxembourg ? 🥰", creationDate: Date().addingTimeInterval(-13789)),
        ...
        Message(author: Author.all[7], lastMessageContent: "Le voyage est la récompense !", creationDate: Date().addingTimeInterval(-756040)),
